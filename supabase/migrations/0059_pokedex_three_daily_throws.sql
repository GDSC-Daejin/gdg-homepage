alter table public.pokemon_throws drop constraint pokemon_throws_user_id_attempted_on_key;
...
begin
  ...
  if (select count(*) from pokemon_throws where user_id = v_user and attempted_on = v_today) >= 3 then
